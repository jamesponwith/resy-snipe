...
func (*snipeFakeProvider) SearchVenuesByName(context.Context, string) ([]domain.Venue, error) {
	return nil, nil
}
...
func TestRunSnipe_EndToEnd_Booked(t *testing.T) {
	...
	finalStatus, err := runSnipe(context.Background(), intent, &snipeFakeSession{}, s, prov, nil, notifier, logger, clk, false)
	if err != nil {
